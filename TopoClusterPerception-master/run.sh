...
##############################################################################################################
##############################################################################################################
mkdir demo/data/scatterplots/
cp data/scatterplots/*.png demo/data/scatterplots/
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_1.png > demo/data/scatterplots/fake_chart_1.json --show_plot True
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_2.png > demo/data/scatterplots/fake_chart_2.json --show_plot True
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_3.png > demo/data/scatterplots/fake_chart_3.json --show_plot True
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_4.png > demo/data/scatterplots/fake_chart_4.json --show_plot True
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_5.png > demo/data/scatterplots/fake_chart_5.json --show_plot True
python density-model.py --histogram_res_x 20 --histogram_res_y 20 --input data/scatterplots/fake_chart_6.png > demo/data/scatterplots/fake_chart_6.json --show_plot True
